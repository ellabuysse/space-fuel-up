...
//            entity.createActivityAction(world, imageStore), entity.actionPeriod);
//      }
//   }
...
//
//      Entity crab = Functions.createCrab(entity.id + CRAB_ID_SUFFIX,
...
//      }
//
//      scheduler.scheduleEvent(entity, entity.createActivityAction(world, imageStore), nextPeriod);
//   }
//
...
//      if (openPt.isPresent())
//      {
//         Entity fish = Functions.createFish(FISH_ID_PREFIX + entity.id,
...
//            Integer.parseInt(properties[OCTO_ANIMATION_PERIOD]), imageStore.getImageList(OCTO_KEY));
...
//            pt, Integer.parseInt(properties[FISH_ACTION_PERIOD]), imageStore.getImageList(FISH_KEY));
//         world.tryAddEntity(entity);
//      }
//
